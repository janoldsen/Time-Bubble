...
public:
	...
	virtual void setImagePivot(int folderID, int fileID, float pivot_x, float pivot_y) = 0;
	virtual SCML_PAIR(float, float) getImagePivot(int folderID, int fileID) const = 0;
